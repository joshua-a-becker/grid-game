  ...
  return (
    <div className="max-w-4xl w-full mx-auto bg-white rounded-lg shadow-lg p-8 my-8">
      ...
      <div className="space-y-4 mb-8">
        <p>Hello! Thank you for joining our activity. In this activity, you will be asked to join a <b>live team activity on an online platform</b>, where you will work on a team consulting task together. <b>The platform allows for live chat and messaging</b> with specific others in your team. Given the live and synchronous nature of this activity, <b>please ensure you are able to be fully attentive to your device for the next 45-minutes.</b></p>
        ...
        <p>After you complete an introductory survey, we will attempt to assign you to a team of 4.  If we are unable to assign you within 2 minutes, we will end the activity and provide you an alternative payment code for the time you spent on this survey.</p>
