...
export const sharedClues = [
    {
        id: 1,
        clue: "The theatre hosts both in-house productions and external shows on two stages: The main stage hosts shows requiring larger sets or casts (seating 1000). A smaller studio theatre (seating 70) hosts small shows on the second floor. There are bars that serve beverages, and a recently installed elevator for seniors or disabled audience members."
    },
    {
        id: 2,
        clue: "External shows are typically Broadway shows that the theater book by paying a certain fee. Internally produced shows are developed by the Riverside Theatre's creative staff and cost less than external shows."
    },
    {
        id: 3,
        clue: "Last year, 53% of group tickets were purchased by corporate groups, 14% by social clubs, 13% hospital staff, 8% by theater clubs, and 5% by charity groups."
    },
    {
        id: 4,
        clue: "Marketing research suggests several demographic groups have registered strong interests. These groups are 1) retirement community and senior clubs, and 2) schools, from kindergarten to high school."
    }
]